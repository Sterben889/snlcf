...
type AboutCallToActionSectionProps = {
  title: string;
  body: string;
  visitButtonText: string;
  visitButtonUrl: string;
  eventsButtonText: string;
  eventsButtonUrl: string;
};
  ...
  return (
    <section className="bg-blue-950 px-4 py-16 text-white sm:px-6 lg:py-20">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 whitespace-pre-line text-blue-100 sm:text-xl">
          {body}
        </p>
